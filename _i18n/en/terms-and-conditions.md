...
These terms govern photography services provided by {{ site.data.contact.business_name }}. They are **binding** once you confirm a booking in writing (e.g. by email or signed quote). A contact form enquiry does not create a contract; these terms are provided there for information only.
...
- **{{ site.data.contact.business_name }}** remains the **copyright holder** of all photographs (Swiss Copyright Act).
...
- Processing of contact and booking data is described in our [Privacy Policy]({% tl privacy %}).
