...
Diese AGB regeln Fotografie-Dienstleistungen von {{ site.data.contact.business_name }}. Sie gelten **verbindlich**, sobald Sie eine Buchung schriftlich bestätigen (z. B. per E-Mail oder unterzeichnetes Angebot). Eine Anfrage über das Kontaktformular begründet noch keinen Vertrag; die AGB dienen dort nur zur Information.
...
- Als Urheber der Fotografien bleibt **{{ site.data.contact.business_name }}** Inhaberin des Urheberrechts (Schweizerisches Urheberrecht, URG).
...
- Die Verarbeitung von Kontakt- und Buchungsdaten richtet sich nach unserer [Datenschutzerklärung]({% tl privacy %}).
