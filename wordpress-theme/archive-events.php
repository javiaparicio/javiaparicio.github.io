...
<main id="main" class="site-main">
    <header class="page-header">
        <h1 class="page-title"><?php _e('Events', 'javi-aparicio-foto'); ?></h1>
    </header>
    ...
    <div class="events-gallery">
            ...
            <div class="gallery">
                <?php while (have_posts()) : the_post(); ?>
                    <?php if (has_post_thumbnail()) : ?>
                        <?php
                        $localized_title = javi_aparicio_get_localized_title(get_the_ID(), 'events');
        ...
        <?php else : ?>
            <p><?php _e('No events found.', 'javi-aparicio-foto'); ?></p>
        <?php endif; ?>
    </div>
</main>
