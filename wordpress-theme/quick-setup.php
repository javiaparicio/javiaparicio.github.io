...
class JaviAparicioQuickSetup {
    ...
    public function setup_page() {
        ...
        <div class="wrap">
            ...
            <div class="setup-steps">
                ...
                <div class="step">
                    <h2>Step 3: Import Content</h2>
                    <p>Import your portraits and events from Jekyll data.</p>
                    <button id="import-content" class="button button-primary">Import Content</button>
                    <div id="content-status"></div>
                </div>
                
                <div class="step">
                    <h2>Step 4: Configure Theme</h2>
                    <p>Set up theme options and contact information.</p>
            ...
            <div class="setup-complete" id="setup-complete" style="display: none;">
                ...
                <ul>
                    <li><a href="<?php echo admin_url('edit.php?post_type=portraits'); ?>">Manage Portraits</a></li>
                    <li><a href="<?php echo admin_url('edit.php?post_type=events'); ?>">Manage Events</a></li>
    ...
    private function import_content() {
        ...
        wp_send_json_success(array('message' => 'Content import completed. Check Portraits and Events sections.'));
    }
    ...
    private function configure_theme() {
        ...
        wp_send_json_success(array('message' => 'Theme configured with default settings.'));
    }
}
